...
const DuiRadioOption = (props: PropsWithChildren<DuiRadioOptionProps> & IDuiColors) => {
  let colors;
  if (props.accent) {
...
const DuiRadioGroup = (props: Props & IDuiColors) => {
  ...
  const onChange = (value: DuiRadioValue) => {
    setValue(value);
