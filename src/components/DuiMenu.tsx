...
const DuiLink = (props: OptionProps & IDuiLink & IDuiColors) => {
...
const DuiMenu = (props: Props & IDuiColors) => {
    const [isMenuVisible, setMenuVisibility] = useState(false);

    const stateClasses = () => props.toggleable && isMenuVisible ? `
    ...
    ` : props.toggleable && !isMenuVisible ? `
    ...
    return (
        <div>
            ...
            <nav className={`
                text-stone-600
                ${ props.smaller
                    ? props.nested ? 'text-md gap-1' : 'text-xl gap-4'
                    : props.nested ? 'text-lg gap-1' : 'text-2xl gap-8'
                }
                ${ stateClasses() }
                ${ props.className }
            `}>
