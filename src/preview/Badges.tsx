    ...
    return (
        <DuiContainer centered className="flex flex-col gap-2">
            <div className="flex items-center gap-2">
                <h2>Badges</h2>
                <p>Can be put on anything <DuiCode inline>relative</DuiCode></p>
            </div>
            ...
            <div className="flex flex-wrap gap-4 mt-4">
                ...
                <DuiControlsGroup accent vertical="true">
                    ...
                    <DuiButton>Update<DuiBadge /></DuiButton>
                    <DuiButton>Delete</DuiButton>
                </DuiControlsGroup>

                <DuiControlsGroup vertical="true">
                    <DuiButton>Create<DuiBadge /></DuiButton>
                    <DuiButton>Read<DuiBadge value={23} /></DuiButton>
                    <DuiButton>Update<DuiBadge pulsating /></DuiButton>
                    <DuiButton>Delete<DuiBadge value={23} pulsating /></DuiButton>
                </DuiControlsGroup>

                <DuiControlsGroup alert vertical="true">
                    <DuiButton>Create<DuiBadge grey /></DuiButton>
                    <DuiButton>Read<DuiBadge grey value={23} /></DuiButton>
                    <DuiButton>Update<DuiBadge secondary pulsating /></DuiButton>
                    <DuiButton>Delete<DuiBadge secondary value={23} pulsating /></DuiButton>
                </DuiControlsGroup>
            </div>
        </DuiContainer>
    );
